...
class WebsiteSupportTicket(models.Model):
    ...
    def create(self, vals):
        ...
        print('New ticket created with ticket number: ', new_id.ticket_number, ' for user id ', new_id.user_id.id)

        # Send FCM notification
        if new_id.user_id.fcm_token_id:
            print('User has an FCM token:', new_id.user_id.fcm_token_id.token)

            # Load the service account key JSON file.
            creds = ServiceAccountCredentials.from_json_keyfile_name(
                r'C:\Users\DELL\odoo11\odoo\addons\website_supportzayd\google-services.json',
            ...
            data = {
                'message': {
                    'token': new_id.user_id.fcm_token,
                    'notification': {
                        'title': 'New Ticket: ' + str(new_id.ticket_number),
